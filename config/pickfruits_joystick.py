import numpy as np
# python main.py config/pickfruits_joystick.py --ckpt 1120_pick_MIX+REAL_nonembed --headless --server local
...
discriminators = {
    "usermotion1/upper": dict(
        #motion_file = "assets/retargeted/pickup_MIXAMO/cml@PickFruit_1_mirrored.npy",  # FOR TEST
        motion_file = "assets/retargeted/pickup_MIXAMO.yaml",
